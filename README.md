...
[Open in Colab](www.google.colab)


**Option 2: Run Locally**

If you prefer to run the notebook on your own computer, you can download the repository from GitHub. See the [Local Setup](#️-local-setup) section below.
